...
class Affine_Model(nn.Module):
    def __init__(self,in_channel,args):
        ...
        self.args = args
        self.unet = UNet(in_channel=in_channel*2,out_channel=1)
    ...
    def forward(self,moving_image,fixed_image):
        ...
        bs,c,ydim,xdim = deformation_matrix.size()

        affine_params = self.decoder(self.encoder(deformation_matrix)).reshape(bs,2,3)
